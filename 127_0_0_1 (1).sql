...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 23, 2016 at 10:04 PM
...
('root', '[{"db":"admins","table":"photo"},{"db":"admins","table":"albums"},{"db":"admins","table":"about"},{"db":"admins","table":"admin"},{"db":"khaled","table":"place"},{"db":"khaled","table":"people"},{"db":"kvector","table":"khaled"}]');
...
('root', 'admins', 'admin', '{"sorted_col":"`admin`.`username`  ASC"}', '2016-04-16 18:11:15'),
('root', 'admins', 'albums', '{"sorted_col":"`albums`.`name`  ASC"}', '2016-04-22 15:00:02');
...
('root', '2016-03-28 11:22:03', '{"collation_connection":"utf8mb4_unicode_ci"}');
